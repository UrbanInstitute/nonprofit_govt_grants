...
county <- data.table::fread(sprintf(file.path(DIR_STATE_FACTSHEETS, "%s_bycounty.csv"),
                                    state))
district <- data.table::fread(sprintf(file.path(DIR_STATE_FACTSHEETS, "%s_bydistrict.csv"),
                                      state))
size <- data.table::fread(sprintf(file.path(DIR_STATE_FACTSHEETS, "%s_bysize.csv"),
                                  state))
subsector <- data.table::fread(sprintf(file.path(DIR_STATE_FACTSHEETS, "%s_bysubsector.csv"),
                                       state))
```
