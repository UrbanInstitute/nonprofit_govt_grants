...
```{r echo=FALSE}
create_gt_table("data/intermediate/factsheet_test_expense_df.csv", "EXPENSE_CATEGORY", "Size")
```
...
:::main_table
```{r echo=FALSE}
create_gt_table("data/intermediate/factsheet_test_subsector_df.csv", "SUBSECTOR", "Subsector")
```
:::
